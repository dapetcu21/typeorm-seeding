...
var EntityFactory = /** @class */ (function () {
    ...
    EntityFactory.prototype.make = function () {
        return tslib_1.__awaiter(this, arguments, void 0, function (overrideParams) {
    ...
    EntityFactory.prototype.create = function () {
        return tslib_1.__awaiter(this, arguments, void 0, function (overrideParams, saveOptions) {
    ...
    EntityFactory.prototype.makeMany = function (amount_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function (amount, overrideParams) {
    ...
    EntityFactory.prototype.createMany = function (amount_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function (amount, overrideParams, saveOptions) {
            var list, index, _a, _b;
            if (overrideParams === void 0) { overrideParams = {}; }
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
    ...
    EntityFactory.prototype.seed = function () {
        return tslib_1.__awaiter(this, arguments, void 0, function (overrideParams) {
            if (overrideParams === void 0) { overrideParams = {}; }
            return tslib_1.__generator(this, function (_a) {
    ...
    EntityFactory.prototype.seedMany = function (amount_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function (amount, overrideParams) {
            if (overrideParams === void 0) { overrideParams = {}; }
            return tslib_1.__generator(this, function (_a) {
    ...
    // Private Helpers
    // -------------------------------------------------------------------------
    EntityFactory.prototype.makeEnity = function () {
        return tslib_1.__awaiter(this, arguments, void 0, function (overrideParams, isSeeding) {
            var entity, key;
            if (overrideParams === void 0) { overrideParams = {}; }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.resolveEntity(this.factory(faker_1.faker, this.context), isSeeding)];
                    case 1:
                        entity = _a.sent();
    ...
    EntityFactory.prototype.resolveEntity = function (entity_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function (entity, isSeeding) {
